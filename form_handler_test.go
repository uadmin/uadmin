	...
	examples := []struct {
	...
	}{
		{
			...
			[]attrExample{
				...
				{"option", "value", "0", "selected", "", 2, "", true},
		...
		},
		{
			...
			[]attrExample{
				...
				{"select", "name", "ParentID", "name", "ParentID", -1, "", true},
				{"option", "value", "0", "selected", "", 2, "", false},
		...
		},
		{
			...
			[]attrExample{
				...
				{"option", "value", "0", "selected", "", 6, "", false},
		...
		},
		{
			...
			[]attrExample{
				...
				{"option", "value", "0", "selected", "", 7, "", false},
				...
				{"select", "name", "ParentID", "name", "ParentID", -1, "", true},
				{"option", "value", "0", "selected", "", 14, "", true},
