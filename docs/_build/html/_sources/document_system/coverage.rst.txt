...
In `Part 2`_, we will discuss about creating and registering an external models in our application.

In `Part 3`_, we will talk about linking models using a foreign key for folders.

In `Part 4`_, we will discuss about folder concepts and how to create records in an application.
